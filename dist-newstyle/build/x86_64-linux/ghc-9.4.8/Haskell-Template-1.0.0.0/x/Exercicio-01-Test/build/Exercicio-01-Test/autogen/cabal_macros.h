...
/* package Haskell-Template-1.0.0.0 */
#ifndef VERSION_Haskell_Template
#define VERSION_Haskell_Template "1.0.0.0"
#endif /* VERSION_Haskell_Template */
#ifndef MIN_VERSION_Haskell_Template
#define MIN_VERSION_Haskell_Template(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Template */
...
#define CURRENT_COMPONENT_ID "Haskell-Template-1.0.0.0-inplace-Exercicio-01-Test"
